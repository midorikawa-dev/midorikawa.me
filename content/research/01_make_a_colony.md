...
ここでは崩壊はまだ持ち込まない。先に欲しいのは、わざと詰まらせなければ続く群れだ。最初から壊れる群れでは、あとで崩壊の原因を切り分けられない。
...
これだけで、順位ができた。小さな差が勝ち負けで増幅され、勝った個体はますます勝ち、負けた個体はますます負ける。やがて、まっすぐな順位が並ぶ。順位ができると、餌の取り方も変わる。上位は餌場に入りやすく、下位は待たされる。社会の上下が、空腹という体の状態に返ってくる。
...
どれも、こちらが設計したものではない。局所のルールを置いただけで、順位・群れ・縄張り・進化が、群れの側からひとりでに出てきた。
