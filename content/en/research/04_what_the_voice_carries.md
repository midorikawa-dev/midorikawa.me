...
So what does that voice carry? Up front: not language. A rat's voice carries mood and situation, not sentences or commands. In the next apparatus I build the rat's voice as close to the real thing as I can, and look at what it conveys and what it does not.

## Bringing the voice closer to the real thing

Until now, the voice inside the colony was just a symbol: a single mark that meant danger. A real rat's voice has more structure. So I rebuild it to match the features described in the literature.
...
The voice became the medium of culture: the voice that teaches, that warns, that brings the colony into step. How durable is what rides on that medium? When the ones who teach are gone, what happens to the knowledge the voice was carrying? The next apparatus looks at what is really lost when the colony collapses.
