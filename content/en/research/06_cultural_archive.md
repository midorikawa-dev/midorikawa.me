...
To the voice-only apparatus I add an external record<sup class="term-note">＊</sup>. An adult who knows a piece of knowledge can write it into a record. Once written, the record works in place of a living teacher. It takes over part of the number of teachers needed to learn. Even when the flesh-and-blood teachers are gone, a record can still meet the required count.
...
Inside the collapsing apparatus, I compare three. A colony that passes things on by voice alone, a colony with a fragile record, and a colony that keeps its record through ritual.
